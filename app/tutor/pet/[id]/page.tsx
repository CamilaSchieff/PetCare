// src/app/vet/consulta/[id]/page.tsx
"use client";
...
  async function handleUpdateStatus(status: "finalizada" | "cancelada" | "em_andamento", newVetId?: number) {
...
      setConsulta(prev => ({ ...prev, status, observacoes, vetId: newVetId || prev.vetId }));
      
