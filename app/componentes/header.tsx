      ...
      >
        {!user && (
          <>
            ...
            <Link href="/login" className="hover:text-[#ff7f50] transition" onClick={() => setOpen(false)}>
              Entrar
            </Link>
            <Link href="/cadastro" className="hover:text-[#ff7f50] transition" onClick={() => setOpen(false)}>
              Criar Conta
            </Link>
          </>
        )}
        ...
        {user?.tipo === "tutor" && (
          <>
            <Link href="/tutor/home" className="hover:text-[#ff7f50] transition" onClick={() => setOpen(false)}>
              Início
            </Link>
            <Link href="/tutor/historico" className="hover:text-[#ff7f50] transition" onClick={() => setOpen(false)}>
              Histórico
            </Link>
            <button
              onClick={() => {
        ...
        {user?.tipo === "veterinario" && (
          <>
            <Link href="/vet/home" className="hover:text-[#ff7f50] transition" onClick={() => setOpen(false)}>
              Agenda
            </Link>
            <Link href="/vet/historico" className="hover:text-[#ff7f50] transition" onClick={() => setOpen(false)}>
              Histórico
            </Link>
            <button
              onClick={() => {
